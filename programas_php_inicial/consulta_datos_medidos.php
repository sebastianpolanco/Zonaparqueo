...
?>
         ...
         <table border=0 width=100%>   
          <tr>
           <td align=right width=50%>
             <font FACE="arial" SIZE=2 color="#000000">Id tarjetas: 
             <select name=estado>
             <?php
                ...
                $id_tarjeta = $_POST["id_tarjeta"];
                 if ($_POST["id_tarjeta"]!="")
                  {  
                    if ($id_tarjeta == "2")
                     {
                      echo "<option value=".$id_tarjeta."> Todos los Usuarios</option>";
                      echo "<option value=1> Usuarios solo Activos</option>";
                      echo "<option value=0> Usuarios solo Inactivos</option>";
                     }
                    else if ($id_tarjeta == "1")
                     {
                      echo "<option value=".$id_tarjeta."> Usuarios solo Activos</option>";
                      echo "<option value=2> Todos los Usuarios</option>";
                      echo "<option value=0> Usuarios solo Inactivos</option>";
                     }
                    else if ($id_tarjeta == "0")
                     { 
                      echo "<option value=".$id_tarjeta."> Usuarios solo Inactivos</option>";
                      echo "<option value=2> Todos los Usuarios</option>";
                      echo "<option value=1> Usuarios solo Activos</option>";
                     }
                  }  
    ...
    <form method=POST action="consulta_datos_medidos.php">
           <td align=center width=50%>
             ...
             <td height="20%" align="left" 				
                    ...
                    style="color: #FFFFFF; 
			             font-weight: bold">
			    <font FACE="arial" SIZE=2 color="#000044"> <b><h1>Consulta datos medidos (&Uacute;ltimos 20)</h1></b></font>  
...
$sql1 = "SELECT * from datos_medidos where ID_TARJ='$id_tarjeta' order by id DESC LIMIT 20"; // Aquí se guarda en la variable sql la sentencia de consulta a realizar
