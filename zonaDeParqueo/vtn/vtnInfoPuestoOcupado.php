<?php
  ...
  $sqlTarifa = "SELECT tarifa from registrostarifas WHERE idUsuario='$idUsuario' order by id DESC LIMIT 1"; 
       ...
       <tr>
        ...
        <tr>
          <td>
            ...
            <!--<a href="vtnVisualizarPuestos.php"><button class="btn">Pagar</button></a>-->
            <button class="btnPagar" onclick="PagarServicio(<?php echo $zona;?>,<?php echo $puesto;?>, <?php echo $idUsuario;?>)">Pagar</button>
