...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 	Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  <html>
    ...
    <body>
      ...
      <table width="80%" align=center cellpadding=5 border=1 bgcolor="FFFFFF" class="tabla">
       ...
       <tr class="submenu">
        ...
        <td valign="top" align=center width=80 height=20 colspan=3 bgcolor="#001532">
            <a href="/zonaDeParqueo/vtn/vtnHistorialPagos.php">Historial Pagos</a>
        </td>
       </tr>
    	 <tr>
      ...
      <?php
        $sql1 = "SELECT * FROM registros inner join tiposdeaccion on registros.idTipoDeAccion=tiposdeaccion.idTipoDeAccion Where idUsuario='$idUsuario'"; 
